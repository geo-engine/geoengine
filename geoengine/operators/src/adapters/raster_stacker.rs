...
impl PartialQueryRect {
    ...
    pub fn new(spatial_bounds: GridBoundingBox2D, time_interval: TimeInterval) -> Self {
        PartialQueryRect {
            spatial_bounds,
            time_interval,
        }
                ...
                ArrayStateProjection::ConsumingStreams {
                    ...
                    StreamState::ProducingTimeSlice {
                        ...
                        let tile = if *current_tile
                            == TileIdx::new_y_x(
                                tile_band_iter.grid_bounds().min_index().y(),
                                tile_band_iter.grid_bounds().min_index().x(),
                            )
                            && *current_stream_band_pos == 0
                        {
...
mod tests {
    ...
    use geoengine_datatypes::{
        ...
        raster::{
            GeoTransform, Grid, GridBoundingBox2D, RasterDataType, TilesEqualIgnoringCacheHint,
        },
