...
pub use crate::contexts::migrations::{
    ...
    migration_0030_stac_provider_authentication::Migration0030StacProviderAuthentication,
};
...
mod migration_0030_stac_provider_authentication;
...
pub fn all_migrations() -> Vec<Box<dyn Migration>> {
    vec![
        ...
        Box::new(Migration0030StacProviderAuthentication),
    ]
}
