    ...
    G: GridSize,
{
    ...
    pub fn global_pixel_spatial_grid_definition(&self) -> SpatialGridDefinition {
        let global_upper_left_idx = self.tile_position.grid_idx()
            * [
    ...
    D: GridSize + Clone + PartialEq,
{
        ...
        D: GridSize,
    {
        ...
        debug_assert_eq!(
            tile_info.tile_size.number_of_elements(),
    ...
    T: Pixel,
{
    ...
    fn bounding_box(&self) -> GridBoundingBox2D {
        ...
        let offset = self.tile_position.grid_idx()
            * [shape.axis_size_y() as isize, shape.axis_size_x() as isize];
        GridBoundingBox2D::new_unchecked(
            offset,
            offset
                + [
