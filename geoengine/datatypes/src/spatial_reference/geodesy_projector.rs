...
use crate::{
    ...
    spatial_reference::{CoordinateProjection, SpatialReference, SpatialReferenceAuthority},
};
...
impl GeodesyCoordinateProjector<geodesy::ctx::Minimal> {
    ...
    pub fn from_spatial_references(
        ...
        GeodesyCoordinateProjector::from_epsg_codes(source.code() as u16, target.code() as u16)
    }
    ...
    pub fn from_epsg_codes(source_crs: u16, target_crs: u16) -> Result<Self, Error> {
        ...
        let transformer = GeodesyCoordinateProjector {
            ctx,
            source_crs,
            source,
            source_latlon,
...
impl<C: geodesy::ctx::Context> GeodesyCoordinateProjector<C> {
...
impl CoordinateProjection for GeodesyCoordinateProjector<geodesy::ctx::Minimal> {
        ...
        Self: Sized,
    {
        ...
        let t = GeodesyCoordinateProjector::from_spatial_references(from, to)?;
...
mod tests {
    ...
    fn transform_coordinate_4326_3857() -> Result<(), Error> {
        ...
        let transformer = GeodesyCoordinateProjector::from_spatial_references(from, to)?;
