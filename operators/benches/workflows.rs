...
use geoengine_operators::{
    engine::{
        ChunkByteSize, MockExecutionContext, MockQueryContext, QueryContext, RasterOperator,
        RasterQueryProcessor, RasterQueryRectangle,
    },
...
fn bench_raster_operator<'a, Q, T, F, C>(
    ...
    F: Fn(TilingSpecification) -> MockExecutionContext,
    C: QueryContext,
