...
fn bench_mock_source_operator_with_expression(bench_collector: &mut WorkflowBenchmarkCollector) {
...
geoengine_operators::workflow_bencher_main!(bench_mock_source_operator_with_expression);
