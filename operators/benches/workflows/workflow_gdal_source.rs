...
fn bench_gdal_source_operator_tile_size(bench_collector: &mut WorkflowBenchmarkCollector) {
    let qrects = vec![
        (
...
geoengine_operators::workflow_bencher_main!(bench_gdal_source_operator_tile_size);
