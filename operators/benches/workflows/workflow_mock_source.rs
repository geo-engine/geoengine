...
use geoengine_operators::engine::{ChunkByteSize, MockExecutionContext, RasterOperator};
...
fn bench_mock_source_operator(bench_collector: &mut WorkflowBenchmarkCollector) {
...
geoengine_operators::workflow_bencher_main!(bench_mock_source_operator);
