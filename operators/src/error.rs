...
pub enum Error {
    ...
    OnnxMultipleInputsNotSupported {
        num_inputs: usize,
    },
    #[snafu(display("Onnx model must have Tensor input. Found {:?}.", input_type))]
    OnnxInvalidInputType {
        input_type: ort::ValueType,
    },
    #[snafu(display(
