...
pub use self::gdal_source::{
    ...
    GdalMetaDataRegular, GdalMetaDataStatic, GdalMetadataFixedTimes, GdalMetadataMapping,
    GdalMetadataNetCdfCf, GdalSource, GdalSourceParameters, GdalSourceProcessor,
