...
impl VectorExpression {
    ...
    pub fn new(r#type: Type, params: models::VectorExpressionParameters, sources: models::SingleVectorSource) -> VectorExpression {
        VectorExpression {
            r#type,
