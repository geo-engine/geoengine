 ...
 * @export
 */
export declare const TimeShiftTypeEnum: {
 ...
 */
export declare function instanceOfTimeShift(value: object): value is TimeShift;
export declare function TimeShiftFromJSON(json: any): TimeShift;
export declare function TimeShiftFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeShift;
export declare function TimeShiftToJSON(json: any): TimeShift;
export declare function TimeShiftToJSONTyped(value?: TimeShift | null, ignoreDiscriminator?: boolean): any;
