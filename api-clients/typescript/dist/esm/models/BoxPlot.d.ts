 ...
 * @export
 */
export declare const BoxPlotTypeEnum: {
 ...
 */
export declare function instanceOfBoxPlot(value: object): value is BoxPlot;
export declare function BoxPlotFromJSON(json: any): BoxPlot;
export declare function BoxPlotFromJSONTyped(json: any, ignoreDiscriminator: boolean): BoxPlot;
export declare function BoxPlotToJSON(json: any): BoxPlot;
export declare function BoxPlotToJSONTyped(value?: BoxPlot | null, ignoreDiscriminator?: boolean): any;
