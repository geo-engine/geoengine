 ...
 */
export declare function instanceOfBoxPlotParameters(value: object): value is BoxPlotParameters;
export declare function BoxPlotParametersFromJSON(json: any): BoxPlotParameters;
export declare function BoxPlotParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): BoxPlotParameters;
export declare function BoxPlotParametersToJSON(json: any): BoxPlotParameters;
export declare function BoxPlotParametersToJSONTyped(value?: BoxPlotParameters | null, ignoreDiscriminator?: boolean): any;
