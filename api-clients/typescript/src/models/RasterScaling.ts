...
import {
    RasterScalingParametersFromJSON,
    RasterScalingParametersFromJSONTyped,
    RasterScalingParametersToJSON,
    RasterScalingParametersToJSONTyped,
} from './RasterScalingParameters';
 ...
 */
export function instanceOfRasterScaling(value: object): value is RasterScaling {
...
export function RasterScalingFromJSON(json: any): RasterScaling {
    return RasterScalingFromJSONTyped(json, false);
}

export function RasterScalingFromJSONTyped(json: any, ignoreDiscriminator: boolean): RasterScaling {
    if (json == null) {
        return json;
    }
    return {
...
export function RasterScalingToJSON(json: any): RasterScaling {
    return RasterScalingToJSONTyped(json, false);
}

export function RasterScalingToJSONTyped(value?: RasterScaling | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
