...
import {
    VectorExpressionParametersFromJSON,
    VectorExpressionParametersFromJSONTyped,
    VectorExpressionParametersToJSON,
    VectorExpressionParametersToJSONTyped,
} from './VectorExpressionParameters';
 ...
 */
export function instanceOfVectorExpression(value: object): value is VectorExpression {
...
export function VectorExpressionFromJSON(json: any): VectorExpression {
    return VectorExpressionFromJSONTyped(json, false);
}

export function VectorExpressionFromJSONTyped(json: any, ignoreDiscriminator: boolean): VectorExpression {
    if (json == null) {
        return json;
    }
    return {
...
export function VectorExpressionToJSON(json: any): VectorExpression {
    return VectorExpressionToJSONTyped(json, false);
}

export function VectorExpressionToJSONTyped(value?: VectorExpression | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
