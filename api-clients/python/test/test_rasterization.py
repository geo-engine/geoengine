...
class TestRasterization(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Rasterization:
        """Test Rasterization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Rasterization`
        """
        model = Rasterization()
        if include_optional:
            return Rasterization(
                type = 'Rasterization',
                params = geoengine_api_client.models.rasterization_parameters.RasterizationParameters(
