...
class TestVisualPointClustering(unittest.TestCase):
    """VisualPointClustering unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VisualPointClustering:
        """Test VisualPointClustering
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VisualPointClustering`
        """
        model = VisualPointClustering()
        if include_optional:
            return VisualPointClustering(
    ...
    def testVisualPointClustering(self):
        """Test VisualPointClustering"""
