...
class SingleVectorSource(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SingleVectorSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SingleVectorSource from a dict"""
        if obj is None:
            return None
...
SingleVectorSource.model_rebuild(raise_errors=False)
