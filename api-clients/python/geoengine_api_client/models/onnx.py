...
class Onnx(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Onnx from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Onnx from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "params": OnnxParameters.from_dict(obj["params"]) if obj.get("params") is not None else None,
...
Onnx.model_rebuild(raise_errors=False)
