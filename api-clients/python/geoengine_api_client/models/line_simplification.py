...
class LineSimplification(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LineSimplification']):
            raise ValueError("must be one of enum values ('LineSimplification')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LineSimplification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LineSimplification from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "params": LineSimplificationParameters.from_dict(obj["params"]) if obj.get("params") is not None else None,
...
LineSimplification.model_rebuild(raise_errors=False)
