...
class Rasterization(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Rasterization']):
            raise ValueError("must be one of enum values ('Rasterization')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Rasterization from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Rasterization from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "params": RasterizationParameters.from_dict(obj["params"]) if obj.get("params") is not None else None,
...
Rasterization.model_rebuild(raise_errors=False)
