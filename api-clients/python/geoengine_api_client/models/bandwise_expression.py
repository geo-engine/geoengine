...
class BandwiseExpression(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BandwiseExpression']):
            raise ValueError("must be one of enum values ('BandwiseExpression')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BandwiseExpression from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BandwiseExpression from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "params": BandwiseExpressionParameters.from_dict(obj["params"]) if obj.get("params") is not None else None,
...
BandwiseExpression.model_rebuild(raise_errors=False)
