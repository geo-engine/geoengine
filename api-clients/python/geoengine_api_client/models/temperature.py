...
class Temperature(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Temperature']):
            raise ValueError("must be one of enum values ('Temperature')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "params": TemperatureParameters.from_dict(obj["params"]) if obj.get("params") is not None else None,
...
Temperature.model_rebuild(raise_errors=False)
