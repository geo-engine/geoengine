...
class Reflectance(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Reflectance']):
            raise ValueError("must be one of enum values ('Reflectance')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Reflectance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Reflectance from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "params": ReflectanceParameters.from_dict(obj["params"]) if obj.get("params") is not None else None,
...
Reflectance.model_rebuild(raise_errors=False)
