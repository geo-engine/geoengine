...
class PieChart(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PieChart']):
            raise ValueError("must be one of enum values ('PieChart')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "params": PieChartParameters.from_dict(obj["params"]) if obj.get("params") is not None else None,
