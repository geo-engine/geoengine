...
class DataUsageTests(unittest.TestCase):
    ...
    def test_data_usage_for_computation(self):
        with UrllibMocker() as m:
            m.post(
                "http://mock-instance/login",
                expected_request_body={"email": "admin@localhost", "password": "adminadmin"},
            ...
            computation_id = UUID("7b08af4a-8793-4299-83c1-39d0c20560f5")

            m.get(
                f"http://mock-instance/quota/computations/{computation_id}",
                json=[
                    {
                        "operatorName": "Raster",
                        "operatorPath": "[]",
            ...
            result = ge.data_usage_for_computation(computation_id)
