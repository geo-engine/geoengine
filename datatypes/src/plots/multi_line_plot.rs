...
mod tests {
    ...
    fn serialization() {
        ...
        assert_eq!(
            ...
            PlotData {
                vega_string: r#"{"$schema":"https://vega.github.io/schema/vega-lite/v4.17.0.json","data":{"values":[{"x":"1970-01-01T00:00:00Z","y":0.0,"series":"S0"},{"x":"1970-01-01T00:00:00Z","y":2.0,"series":"S1"},{"x":"1970-01-01T00:00:01Z","y":1.0,"series":"S0"}]},"description":"Multi Line Chart","encoding":{"x":{"field":"x","title":"Time","type":"temporal"},"y":{"field":"y","title":"","type":"quantitative"},"color":{"field":"series","scale":{"scheme":"category20"}}},"mark":{"type":"line","line":true,"point":true}}"#.to_owned(),
                metadata: PlotMetaData::None,
            }
        );
    }
