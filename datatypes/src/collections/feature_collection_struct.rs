use crate::collections::multi_line_string_collection::MultiLineStringIterator;
use crate::collections::multi_point_collection::MultiPointIterator;
use crate::collections::multi_polygon_collection::MultiPolygonIterator;
...
use crate::primitives::{
    ...
    MultiLineString, MultiLineStringRef, MultiPoint, MultiPointRef, MultiPolygon, MultiPolygonRef,
    NoGeometry, NullableCategoricalDataRef, NullableDecimalDataRef, NullableNumberDataRef,
...
pub struct FeatureCollection<CollectionType> {
    table: StructArray,
    types: HashMap<String, FeatureDataType>, // TODO: make it a `CoW`?
    ...
    CollectionType: Geometry + ArrowTyped,
{
    ...
    pub fn empty() -> Self {
        ...
        Self {
            table: StructArray::from(ArrayData::builder(DataType::Struct(columns)).len(0).build()),
    ...
    pub fn from_data(
        ...
        Ok(Self {
            table: struct_array_from_data(columns, arrays, number_of_rows),
            types,
            collection_type: Default::default(),
        })
    }
    ...
    ///
    pub fn data(&self, column_name: &str) -> Result<FeatureDataRef, FeatureCollectionError> {
        ensure!(
    ...
    pub fn add_columns(
        ...
        Ok(Self {
            table: struct_array_from_data(columns, column_values, self.table.len()),
            types,
            collection_type: Default::default(),
        })
    }
    ...
    ///
    pub fn remove_column(&self, column_name: &str) -> Result<Self, FeatureCollectionError> {
    ...
    ///
    pub fn filter(&self, mask: Vec<bool>) -> Result<Self, FeatureCollectionError> {
        ensure!(
    ...
    ///
    pub fn append(&self, other: &Self) -> Result<Self, FeatureCollectionError> {
        ensure!(
