...
pub use query_rectangle::{
    ...
    RasterSpatialQueryRectangle, SpatialGridQueryRectangle, SpatialQuery, SpatialQueryRectangle,
    TemporalQuery, VectorQueryRectangle, VectorSpatialQueryRectangle,
};
