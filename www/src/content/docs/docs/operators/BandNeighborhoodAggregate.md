...
| --------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------- |
| aggregate | BandNeighborhoodAggregateMethod | The aggregation method to apply to neighboring bands.<br><br>The average method computes the mean over the current band window, while the<br>first-derivative method approximates the derivative using the configured band distance. | `{"bandDistance":{"distance":1}}`<br>`{"windowSize":3}`<br>`{"type":"average","windowSize":3}` |
