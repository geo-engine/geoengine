...
| featureAggregation              | FeatureAggregationMethod  | The aggregation function to use for features covering multiple pixels.                                                                                                                                                                                                                                                                                                                                                                         | `"first"`  |
| featureAggregationIgnoreNoData  | boolean                   | Whether to ignore no data values in the aggregation. Defaults to `false`.                                                                                                                                                                                                                                                                                                                                                                      | `true`     |
| temporalAggregation             | TemporalAggregationMethod | The aggregation function to use for features covering multiple (raster) time steps.                                                                                                                                                                                                                                                                                                                                                            | `"mean"`   |
