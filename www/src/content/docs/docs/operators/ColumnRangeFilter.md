...
| ranges    | array   | One or more inclusive ranges for the selected column values.<br>Numeric ranges use `[start, end]`; string ranges use `["a", "k"]`. | `[{"type":"float","start":0,"end":50}]`       |
