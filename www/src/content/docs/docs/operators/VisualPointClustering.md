...
| columnAggregates | object | Map of source columns to aggregation definitions used for clustered output attributes. | `{"mean_population":{"columnName":"population","aggregateType":"MeanNumber","measurement":{"type":"unitless"}},"sample_names":{"columnName":"name","aggregateType":"StringSample"}}` |
