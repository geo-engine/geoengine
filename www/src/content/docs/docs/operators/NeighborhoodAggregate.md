...
| ----------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- |
| neighborhood      | NeighborhoodKernel          | Neighborhood definition applied around each pixel.<br>This can be a rectangular neighborhood or a custom weights matrix. | `{"dimensions":[3,3]}`<br>`{"weights":[[1,0,-1],[2,0,-2],[1,0,-1]]}`<br>`{"type":"rectangle","dimensions":[3,3]}` |
| aggregateFunction | NeighborhoodAggregateMethod | Aggregate function applied across the neighborhood values.                                                               | `"sum"`                                                                                                           |
