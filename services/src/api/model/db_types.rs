use super::{
    datatypes::{
        BoundingBox2D, Breakpoint, CacheTtlSeconds, ClassificationMeasurement, Colorizer,
        ContinuousMeasurement, Coordinate2D, DateTimeParseFormat, DefaultColors, FeatureDataType,
        GdalConfigOption, LinearGradient, LogarithmicGradient, Measurement, MultiLineString,
        MultiPoint, MultiPolygon, NoGeometry, OverUnderColors, Palette, RgbaColor,
        SpatialReferenceOption, TimeInstance, TimeInterval, TimeStep, VectorDataType,
    },
    operators::{
        CsvHeader, FileNotFoundHandling, FormatSpecifics, GdalDatasetGeoTransform,
        GdalDatasetParameters, GdalMetaDataList, GdalMetaDataRegular, GdalMetaDataStatic,
    ...
    for GfbioCollectionsDataProviderDefinitionDbType
{
    fn from(other: &GfbioCollectionsDataProviderDefinition) -> Self {
        Self {
            ...
            cache_ttl: other.cache_ttl.into(),
        }
    }
}
