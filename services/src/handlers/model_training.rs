...
use crate::machine_learning::{schedule_ml_model_training_task, MLTrainRequest};
...
mod tests {
    ...
    use geoengine_operators::engine::{MockQueryContext, MultipleRasterSources};
    ...
    async fn ml_model_from_workflow_task_success() {
        use crate::machine_learning::TrainingParams::Xgboost;
        ...
        let model = exe_ctx.load_ml_model(model_id).await.unwrap();
    ...
    fn generate_ml_train_request() -> crate::machine_learning::MLTrainRequest {
        ...
        let tree_params =
            crate::machine_learning::xgb_config_builder::TreeBoosterParametersBuilder::default()
                .eta(0.75)
                .tree_method(crate::machine_learning::xgb_config_builder::TreeMethod::Hist)
                .process_type(crate::machine_learning::xgb_config_builder::ProcessType::Default)
                .max_depth(15)
                .build()
                .expect("could not create tree booster parameters");

        let learning_params =
            crate::machine_learning::xgb_config_builder::LearningTaskParametersBuilder::default()
                .num_class(Some(unique_label_count as u32))
                .objective(crate::machine_learning::xgb_config_builder::Objective::MultiSoftmax)
                .build()
                .expect("could not create learning task parameters");

        // this will be passed to the xgboost crate
        let booster_params =
            crate::machine_learning::xgb_config_builder::BoosterParametersBuilder::default()
                .booster_type(
                    crate::machine_learning::xgb_config_builder::BoosterType::Tree(tree_params),
                )
        ...
        crate::machine_learning::MLTrainRequest {
            query: qry,
